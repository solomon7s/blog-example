 ...
 * @OA\Schema()
 */
final class PostPaginationDTO extends DataTransferObject
{
    /**
     * @var int
    ...
    /**
     * @var Collection
     * @OA\Property(type="array", property="data", @OA\Items(type="object", ref="#/components/schemas/PostDTO"))
     */
    ...
    public static function createFromPagination(LengthAwarePaginator $paginatedData): self
    {
        $data = $paginatedData->map(
            fn(Post $post) => PostDTO::createFromModel($post)
        );
        return new self( [
